...
import {
  DiscoverGridCellModalContext,
  useCellModal,
} from './discover_grid_cell_modal';
import {
  defaultPageSize,
  GRID_STYLE,
  pageSizeArr,
...
export const DiscoverGrid = ({
   ...
   * Cell Modal
   */
  const { cellModalContext, cellModal } = useCellModal()
  ...
  return (
    ...
    >
      <DiscoverGridCellModalContext.Provider value={cellModalContext}>
        <span
        ...
        {cellModal}
      </DiscoverGridCellModalContext.Provider>
    </DiscoverGridContext.Provider>
  );
};
